...
contract BlindAuction {
    ...
    // address that receives the winning bid coins at the end.
    ...
    // encryption for recording the bid value
    // this must be hash value
    // only hash value can be bid
    ...
    // withdraw the initially bid funds
